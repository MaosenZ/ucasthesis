...
\title{在ATLAS实验上寻找超出标准模型希格斯粒子} % 论文中文题目
\author{周茂森}% 论文作者
...
%-> 英文封面信息
%-
\TITLE{Search for the BSM Higgs boson with the ATLAS detector at LHC} % 论文英文题目
...
\keywords{ATLAS, 超出标准模型希格斯粒子, ITk}% 中文关键词
%-
%-> 英文摘要
%-
...
\KEYWORDS{ATLAS, BSM Higgs, ITk}% 英文关键词
%---------------------------------------------------------------------------%
