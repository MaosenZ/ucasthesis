...
\caption{$hh$ $\Delta limit/limit$总结，每行对应去掉该项NP之后上限的变化。}
...
\caption{$SS$ $\Delta limit/limit$总结，每行对应去掉该项NP之后上限的变化。}
...
\end{tabular}}
%\caption{$\Delta limit/limit$ is shown after switching off specific uncertainty in SS model}
\caption{$SS(m_X=340~\text{GeV})$ $\Delta limit/limit$总结，每行对应去掉该项NP之后上限的变化。}
