...
\subsection{$hh$搜寻筛选结果}
\input{tables/cutflow_SigOpt_ee_nonres.tex}
\caption{The unblinded results of non-resonant search in $ee$ channel. }
\label{cutflow_ee_nonres}
\end{table}

\input{tables/cutflow_SigOpt_mumu_nonres.tex}
\caption{The unblinded results of non-resonant search in $\mu\mu$ channel. }
\label{cutflow_mumu_nonres}
\end{table}

\input{tables/cutflow_SigOpt_emu_nonres.tex}
...
\input{tables/cutflow_SigOpt_ee_mH500.tex}
...
\input{tables/cutflow_SigOpt_emu_mH500.tex}
...
\input{tables/cutflow_SigOpt_mumu_HSS_lowmass.tex}
...
\input{tables/cutflow_SigOpt_mumu_HSS_highmass.tex}
